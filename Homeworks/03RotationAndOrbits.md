...
4. A typical neutron star (a collapsed burned-out star, composed of packed neutrons) has a radius of 10km, and a mass 466,000 times that of Earth.  
   ...
   b. Then, based on your result figure what speed is needed to maintain an orbit around the surface of that neutron star.  You can be sure it has a perfectly smooth surface given the gravity involved.
